//
//  PendingUploadResponse.swift
//  SweetMagicalMusicBox
//
//  Created by Alexandre Bianchi on 27/03/21.
//

// MARK: - PendingUploadResponse

struct PendingUploadResponse: Codable {
    let pendingDescription: [JSONAny]
    let pendingModeration, pendingProcessing: [Pending]
...
struct Pending: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case license, tags, created, images, id, name
